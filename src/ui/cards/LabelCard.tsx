...
export default function LabelCard(props: IProps) {
  ...
  const boxColorVariants: colorIndex & colorVariants = {
    ...
    violet:
      "w-max h-max rounded border border-violet-600 text-violet-600 px-2 flex items-center  bg-violet-600/10",
    indigo:
    ...
    red: "w-max h-max rounded border border-red-700 text-red-700 px-2 flex items-center bg-red-700/10",
    cyan: "w-max h-max rounded border border-cyan-500 text-cyan-500 px-2 flex items-center  bg-cyan-500/20",
    white:
      "w-max h-max rounded border border-neutral-300 text-neutral-300 px-2 flex items-center bg-neutral-300/20",
  };
